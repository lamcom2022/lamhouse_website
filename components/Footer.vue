    ...
    <!-- Section 7 -->
      <section class="w-full bg-primary-900">
          <div class="px-8 py-12 mx-auto max-w-7xl">
              <div class="grid grid-cols-2 gap-20 mb-3 md:grid-cols-3 lg:grid-cols-12 lg:gap-20">
                  <div class="col-span-5">
                      ...
                      <p class="my-4 text-sm leading-normal text-primary-100">
                       ...
                       <span class="inline-flex justify-center w-full mt-12 space-x-5 sm:ml-auto sm:justify-start">
              ...
              <div class="flex flex-col items-start justify-between pt-10 mt-10 border-t border-blue-500 md:flex-row md:items-center">
                  <p class="mb-6 text-sm text-left text-blue-200 md:mb-0">© Copyright 2022 BeyondBorder. All Rights Reserved.</p>
                  <div class="flex items-start justify-start space-x-6 md:items-center md:justify-center">
                      <a href="https://lamhouse.in/" class="text-sm text-blue-200 transition hover:text-white">Developed By Lamhouse</a>
