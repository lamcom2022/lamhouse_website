<template>
  <div class="bg-white pt-10 pb-20">
    ...
    <div
      class="max-w-7xl inline-block mx-auto mt-6 pt-5 grid gap-4 lg:grid-cols-4 lg:gap-x-4 lg:gap-y-8"
    >
      <div class="flex justify-center w-full bg-white shadow-lg h-64">
        <img
          class="w-full aspect-auto object-none object-center"
          src="https://res.cloudinary.com/lamcom/image/upload/v1662791566/lamhouse/clientlogo/advik_t23t7y.png"
        />
      </div>
      <div class="flex justify-center w-full bg-white shadow-lg h-64">
        <img
      ...
      <div class="flex justify-center w-full bg-white shadow-lg h-64">
        <img
          class="w-full aspect-auto object-none object-center"
          src="https://res.cloudinary.com/lamcom/image/upload/v1662710561/lamhouse/clientlogo/covidfix_let8jk.png"
        />
      </div>
      <div class="flex justify-center w-full bg-white shadow-lg h-64">
        <img
