<template>
	<main
		...
		<h1 class="capitalize font-semibold text-[38px] lg:text-7xl text-center leading-snug text-white">
			Largest commercial laundry<br />
			<span class="font-extrabold bg-clip-text text-primary-500">in Middle East</span>
		</h1>
		<p class="mt-10 text-small text-center text-white font-medium">
			We are opening new Laundry Shops in Breada, Anesha, Majmaha and Madina
		</p>
