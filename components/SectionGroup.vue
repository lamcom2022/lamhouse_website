<template>
  <div class="pb-8">
    <h2 class="text-lg font-medium text-gray-900">Nearest Store Locator</h2>
  ...
  <div class="space-y-4 min-h-0 h-96 overflow-y-auto">
    ...
    <label
      v-for="(location, idx) in locations.locations"
      :key="idx + '_' + location.name"
      ...
      :class="
        selected.name == location.name
          ? 'bg-primary-50 ring-1 ring-offset-0 ring-primary-500 border-2 border-primary-300 hover:border-primary-400'
