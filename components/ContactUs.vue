            ...
            <dl class="mt-2 text-base leading-20 text-white w-full">
                <div>
                    ...
                    <dd class="pt-3">
                        ...
                        <p>{{menuitems.contactus.city}} - {{menuitems.contactus.zip}}</p>
                        <p class="mt-4"> {{menuitems.contactus.state}}</p>
                        <p> {{menuitems.contactus.country}}</p>
                ...
                <div class="mt-2">
                    ...
                    <dd class="flex">
                        ...
                        >
                            ...
                            <span class="ml-3">
                                {{menuitems.contactus.phone1}}
                            </span>
                    </dd>
                    <dd
                        class="flex"
                        v-if="menuitems.contactus.phone2"
                    >
                        <!-- Heroicon name: phone -->
                        <svg
                            class="flex-shrink-0 h-6 w-6 text-white"
                        ...
                        >
                            ...
                            <span class="ml-3">
                                {{menuitems.contactus.phone2}}
                            </span>
                            </dd>
                            <dt
                                class="sr-only"
                                v-if="menuitems.contactus.fax"
                            >Fax number</dt>
                                <dd
                                    class="flex"
                                    v-if="menuitems.contactus.fax"
