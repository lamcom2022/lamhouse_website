<template>
 <!-- Banner section -->
    ...
    style="background-image: url('https://res.cloudinary.com/lamcom/image/upload/v1669026805/sravya/herobanner/banner-about_m0ebsd.jpg')">
        ...
        <div class="relative z-20 px-4 py-24 mx-auto text-center text-white max-w-7xl lg:py-32">
            <div class="flex flex-wrap text-white">
                <div class="relative w-full px-4 mx-auto text-center xl:flex-grow-0 xl:flex-shrink-0">
                    ...
                    <h1 class="mt-0 mb-2 text-4xl font-bold text-white sm:text-5xl lg:text-7xl">About</h1>
  ...
  <section class="w-full bg-white md:pt-12 md:pb-24">
    ...
    >
      ...
      >
        <img
          src="https://res.cloudinary.com/lamcom/image/upload/v1668697817/sravya/images/prof_m3kjtq.jpg"
        />
      </div>
      ...
      >
        ...
        <p
          ...
          "
        >
          SRAVYA FOOD AND BEVERAGES, established in May 2018, is a
          Proprietorship Company.
        </p>
        <p class="pt-4 pb-4 leading-7">
          The Founder/CEO, Mr. Chakrapani has gathered vast experience in
          managing and marketing companies along with creating innovative
          solutions for these companies.
        </p>
        <p>
          Sravya Food and Beverages deals with Food and Agro-based commodities
          across the globe.
        </p>
      </div>
      <!-- End  Content -->
    ...
    >
      <div class="flex flex-wrap -mx-5 mt-0 box-border">
        ...
        >
          ...
          >
            <svg
              ...
              height="32"
              fill="white"
              class="bi bi-eye mx-auto items-baseline"
              viewBox="0 0 16 16"
            >
              <path
          ...
          <h3
            class="mt-0 mb-2 font-extrabold text-xl tracking-normal box-border"
          >
            Vision Statement
          </h3>
          <p class="mt-0 mb-8 md:mb-0 box-border text-gray-200">
            To be a Globally Recognized Import- Export Company, that prioritizes
            service, quality, and satisfaction of its customers, employees and
            stakeholders.
          </p>
        </div>
        <!-- Feature 2 -->
        ...
        >
          ...
          <p class="mt-0 mb-8 md:mb-0 box-border text-gray-200">
            Sravya Food And Beverages aspires to offer customers a seamless
            experience with products of superior quality, across the globe,
            thereby contributing to the growth of society along with personal
            growth of business.
          </p>
        </div>
        ...
        >
          ...
          <p class="mt-0 mb-8 md:mb-0 box-border text-gray-200">
            Our Core Values revolve around Service, Integrity and Quality.
          </p>
        </div>
      </div>
    </div>
  ...
  <!-- Section 5 -->
  <section
    class="relative leading-7 text-gray-900 bg-white border-solid pt-24 pb-24"
  >
    <div class="box-border mx-auto border-solid lg:pl-8 max-w-7xl">
      ...
      >
        ...
        >
          ...
          <p
            class="mt-2 text-xl text-left border-0 border-gray-200 sm:text-2xl"
          >
            ...
            <div class="box-border flex items-start text-gray-900 border-solid">
              ...
              <div class="flex-1 ml-6 leading-7 border-0 border-gray-200">
                ...
                <p
                  ...
                  "
                >
                  We believe that customer service is an important key to
                  success. Therefore, we strive to ensure effective and smooth
                  processes and procedures to our customers along with timely
                  delivery.
                </p>
              </div>
            </div>
            <div class="box-border flex items-start text-gray-900 border-solid">
              ...
              <div class="flex-1 ml-6 leading-7 border-0 border-gray-200">
                ...
                <p
                  ...
                  "
                >
                  We believe that integrity and respect of our customers and the
                  environment is very important for our development and growth.
                </p>
              </div>
            </div>
            <div class="box-border flex items-start text-gray-900 border-solid">
              ...
              <div class="flex-1 ml-6 leading-7 border-0 border-gray-200">
                ...
                <p
                  ...
                  "
                >
                  We believe in procuring superior quality products for our
                  customers and ensuring the maintenance of these standards. We
                  believe that providing good quality products will create
                  mutual trust between our company and our valued customers.
                </p>
              </div>
            </div>
          </div>
        ...
        <div class="lg:w-2/5">
          <img
            src="https://res.cloudinary.com/lamcom/image/upload/v1668697361/sravya/images/choose_jqqeez.jpg"
          />
        </div>
      </div>
    </div>
