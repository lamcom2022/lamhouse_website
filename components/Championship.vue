  ...
  <div class="tab-pane fade" id="tabs-messagesFill" role="tabpanel" aria-labelledby="tabs-profile-tabFill">
    ...
    <div class="bg-white pt-10 pb-20">
        <div class="grid max-w-7xl mx-auto pt-10 pb-10">
         ...
         <div class="grid lg:max-w-7xl mx-4">
    <div class="grid justify-center">
      <ul class="flex mb-0 list-none pt-3 pb-4 w-full">
        ...
        <li class="-mb-px mr-2 last:mr-0 grid text-center">
        ...
        <li class="-mb-px mr-2 last:mr-0 flex-auto text-center">
         ...
         <li class="-mb-px mr-2 last:mr-0 flex-auto text-center">
          <a class="text-xs font-bold uppercase px-5 py-3 shadow-lg rounded block leading-normal" v-on:click="toggleTabs(4)" v-bind:class="{'text-slate-600 bg-white': openTab !== 4, 'text-white bg-primary-600': openTab === 4}">
            Result
          </a>
        </li>
      </ul>
        ...
        <div class="px-4 py-5 flex-auto">
          <div class="tab-content tab-space">
            <div v-bind:class="{'hidden': openTab !== 1, 'block': openTab === 1}">
             <div class="max-w-7xl mx-auto mt-6 pt-5 lg:grid gap-4 lg:gap-x-4 lg:gap-y-8">             
              <p class="text-center mt-12">International Events</p>
             </div>
            </div>

            <div v-bind:class="{'hidden': openTab !== 2, 'block': openTab === 2}">
              <div class="max-w-7xl mx-auto mt-6 pt-5 lg:grid gap-4 lg:gap-x-4 lg:gap-y-8">             
                 <p class="text-center mt-12">National Events</p>
             </div>
            </div>

            <div v-bind:class="{'hidden': openTab !== 3, 'block': openTab === 3}">
              <div class="max-w-7xl mx-auto mt-6 pt-5 lg:grid gap-4 lg:gap-x-4 lg:gap-y-8"> 
                 <p class="text-center mt-12">State Events</p>        
             </div>
            </div>

           <div v-bind:class="{'hidden': openTab !== 4, 'block': openTab === 4}">
              <div class="max-w-7xl mx-auto mt-6 pt-5 lg:grid gap-4 lg:gap-x-4 lg:gap-y-8">             
                 <p class="text-center mt-12">Results</p>
             </div>
            </div>
