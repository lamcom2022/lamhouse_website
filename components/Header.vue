<template>
  <header
    class="flex1 flex items-center bg-secondary justify-between h-20 lg:max-w-8xl mx-auto px-5 lg:px-5"
  >
    <!-- Logo (Start)-->
    <NuxtLink to="/">
    ...
    >
      ...
      >
        <div
          class="lg:block h-12 pointer-events-none absolute inset-x-0 z-10 bg-gradient-to-b from-white"
        ></div>
        ...
        <div
          class="mt-12 mx-7 px-5 py-2 w-36 text-center text-sm bg-primary text-white rounded-full transition-all duration-300"
        >
        ...
        >
          <span
            class="flex items-center px-5 py-2 text-sm bg-primary text-white rounded-full transition-all duration-300"
          >
            <span class="w-24 mx-2 font-medium text-white text-center"
              >Contact us</span
            >
          </span>
        </button>
    ...
    <div class="hidden space-x-8 md:ml-10 md:flex">
      ...
      >
        <div class="relative" v-if="menu.children">
          <button
            type="button"
            class="group inline-flex items-center space-x-2 font-bold text-xl leading-6 focus:outline-none transition ease-in-out duration-150 text-white hover:text-white focus:text-white"
          >
            <span>{{ menu.title }}</span>
            <!-- Item active: "text-white", Item inactive: "text-white-400" -->
            <svg
              class="transition ease-in-out duration-150 text-white h-5 w-5 group-hover:text-white group-focus:text-white"
              viewBox="0 0 20 20"
              fill="currentColor"
            >
              <path
                  ...
                  >
                    ...
                    >
                      ...
                      <div v-else>
                        ...
                        <svg
                          class="flex-shrink-0 h-6 w-6 fill-primary-500"
                          fill="none"
                          viewBox="0 0 24 24"
                          stroke="currentColor"
                        >
    ...
    <div class="hidden md:flex md:items-center md:space-x-6">
      ...
      <div
        class="px-5 py-2 text-sm bg-primary text-white rounded-full transition-all duration-300"
      >
        <a href="/form">Book Now</a>
      </div>
      <button
  ...
  <div @click="toggleMobileMenu" class="-mr-2 items-center sm:hidden">
    ...
    >
      ...
      <svg
        xmlns="http://www.w3.org/2000/svg"
        class="h-6 w-6 text-white hover:text-primary-500"
        fill="fill-white"
        viewBox="0 0 24 24"
        stroke="currentColor"
      >
