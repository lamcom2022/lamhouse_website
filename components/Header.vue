<template>
        ...
        ">
          ...
          ">
			...
			<div class="hidden space-x-8 md:ml-10 md:flex">
				<div v-for="(menu, idx) in menuitems.nav" @mouseover="showMenu(idx)"
                      ...
                      ">
                        ...
                        ">
												<div v-if="childmenu.img">
													<img :src="childmenu.img" width="30" height="30"
														:alt="childmenu.title" />
												</div>
												<div v-else>
	...
	<div @click="toggleMobileMenu" class="-mr-2 items-center sm:hidden">
      ...
      " aria-expanded="false">
			...
			<svg xmlns="http://www.w3.org/2000/svg" class="h-6 w-6 text-primary-900 hover:text-primary-500"
				fill="fill-white" viewBox="0 0 24 24" stroke="currentColor">
