<template>
  <div class="max-w-8xl flex flex-auto lg:grid-cols-3">
    <header
      class="lg:space-x-64 flex1 flex items-center bg-white h-20 px-5 lg:px-5"
    >
      <!-- Logo (Start)-->
      <NuxtLink to="/">
      ...
      <div class="lg:flex md:grid lg:col-span-3 md:col-span-1">
        ...
        <svg
          ...
          height="16"
          fill="currentColor"
          class="bi bi-telephone mt-1 text-primary-500"
          viewBox="0 0 16 16"
        >
          <path
  ...
  <div @click="toggleMobileMenu" class="-mr-2 items-center sm:hidden">
    ...
    >
      ...
      <svg
        xmlns="http://www.w3.org/2000/svg"
        class="h-6 w-6 text-primary-900 hover:text-primary-500"
        fill="fill-white"
        viewBox="0 0 24 24"
        stroke="currentColor"
      >
