<template>
  <div class="fixed top-0 z-10 bg-gray-50 w-full">
    <header
      class="flex1 flex items-center bg-primary-900 justify-between h-20 lg:max-w-8xl mx-auto px-0 lg:px-5"
    >
      <!-- Logo (Start)-->
      <NuxtLink to="/">
      ...
      >
        <div
          id="navwrapper"
          class="h-full overflow-y-auto scrolling-touch lg:h-auto lg:block lg:sticky lg:bg-transparent overflow-hidden lg:top-18 bg-white"
        >
          <div
            class="lg:block h-12 pointer-events-none absolute inset-x-0 z-10 bg-gradient-to-b from-white"
          ></div>
          <div class="px-0 pt-4 flex items-center justify-between">
            <div>
              <a href="/">
                <img
                  class="h-8 w-auto"
          ...
          <nav
            id="nav"
            class="px-1 pt-6 overflow-y-auto font-medium text-base sm:px-0 xl:px-5 lg:text-sm pb-10 lg:pt-10 lg:pb-14 sticky?lg:h-(screen-18)"
          >
            <LeftNavColor :data="[]" />
          </nav>
        </div>
      ...
      <!-- Nav Starts-->
      <!--Main Menu (Start)-->
      <div class="hidden space-x-8 md:ml-5 md:flex">
        <div
