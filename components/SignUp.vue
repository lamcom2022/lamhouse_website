              ...
              >
                <div class="flex items-center justify-between space-x-3">
                  ...
                  <div class="h-7 flex items-center">
                    <button
                      v-on:click="isSignUpFormVisible = false"
                ...
                <div>
                  <p class="text-sm leading-5 text-white">
                    The information that you have provided in this registration
                    form is used by us so that we can contact you regarding
                    classes and events, as well as ensuring that we are able to
                    contact you in an emergency.Information collected by this
                    form will be held for a limited time in accordance with
                    GDPR.
                  </p>
                </div>
              </header>
                    ...
                    >
                      ...
                      <div class="sm:overflow-hidden">
                        <section aria-labelledby="shipping-heading">
                          ...
                          <div
                            class="mt-6 grid grid-cols-1 gap-y-6 gap-x-4 sm:grid-cols-3"
                          >
                            <!-- Checkboxes (Start)-->
                            <div
                              class="pt-2 space-y-4 sm:pt-2 sm:space-y-4 sm:col-span-6"
                            >
                              <div
                                    ...
                                    >
                                      <div>
                                        <div
                                          ...
                                          id="label-email"
                                        >
                                          Select the classes you would like to
                                          register.
                                        </div>
                                      </div>
                          ...
                          >
                            ...
                            <div class="sm:col-span-6">
                              ...
                              <p class="mt-2 text-sm text-gray-500">
                                e.g Asthma, nut allergy. Please state N/A if
                                there is no medical information that we need to
                                be aware of
                              </p>
                            </div>
                          </div>
                                          ...
                                          >
                                            ...
                                            <div class="ml-3 text-sm">
                                              <label
                                                ...
                                                >I hereby agree that my data
                                                entered in the contact form will
                                                be stored electronically, and
                                                will be processed and used for
                                                the purpose of establishing
                                                contact. I am aware that I can
                                            ...
                                            >
                                              ...
                                              <div class="ml-3 text-sm">
                                                <label
                                                  ...
                                                  child to be in the
                                                  photos/videos taken for
                                                  promotional purposes/social
                                                  media/display on the school
                                                  website</label
                                                >
                                              </div>
                                            </div>
  ...
  methods: {
    async SignUp(args) {
      try {
        ...
        alert(
          "Thankyou for getting in touch! We will respond within 48 hours."
        );
        this.data = {};
