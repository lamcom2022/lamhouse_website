<template>
    ...
    <section class="relative flex flex-col-reverse w-full px-6 py-16 bg-gray-900 lg:pt-0 lg:flex-col lg:pb-0">
        <div class="inset-y-0 top-0 right-0 z-0 w-full max-w-xl px-4 mx-auto md:px-0 lg:pr-0 lg:mb-0 lg:mx-0 lg:w-7/12 lg:max-w-full lg:absolute xl:px-0">
            ...
            <img class="object-cover w-full h-56 rounded shadow-lg lg:rounded-none lg:shadow-none md:h-96 lg:h-full" src="https://res.cloudinary.com/lamcom/image/upload/v1668749978/sravya/herobanner/home-banner_vyztzu.jpg" alt="">
        </div>
        <div class="relative flex flex-col items-start w-full max-w-xl px-4 mx-auto md:px-0 lg:px-8 lg:max-w-screen-xl">
            <div class="mb-16 lg:my-40 lg:max-w-lg lg:pr-5">
                 <h1 class="mb-5 font-sans text-3xl font-bold tracking-tight text-primary-500 sm:text-6xl sm:leading-none">
                    Sravya<br class="hidden md:block">
                    <span class="inline-block text-secondary-500">Food and Beverages</span>
                </h1>
